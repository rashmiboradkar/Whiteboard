...
public class MainActivity extends AppCompatActivity {
    ...
    private void changeMarkerColor() {
        ...
        startActivityForResult(new Intent(com.Java.whitebordapp.MainActivity.this, ColorSelectActivity.class), REQ_COLOR);
    }

    private void changeMarkerThickness() {
        startActivityForResult(new Intent(com.Java.whitebordapp.MainActivity.this, ThicknessSelectActivity.class), REQ_THICKNESS);
    }
